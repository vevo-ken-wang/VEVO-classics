...
/**
 * @license AngularJS v1.3.0-build.2454+sha.e118a8b
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-build.2454+sha.e118a8b/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-build.2454+sha.e118a8b',    // all of these placeholder strings will be replaced by grunt's
...
},{"./index-controller":4,"angular-route/angular-route":1,"angular/angular":2}],4:[function(require,module,exports){
var ctrl;
